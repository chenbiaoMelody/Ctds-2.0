...
| [docs/03-C-TDS项目研发章程与开发规范.md](docs/03-C-TDS项目研发章程与开发规范.md) | 研发章程 V2.4（最高制度；V2.4 新增编码前"两级设计门禁"） |
...
| [docs/designs/](docs/designs/) | 两级设计文档（低保真/高保真 + 界面原型；**编码前强制 PO 确认**，章程 2.6） |
