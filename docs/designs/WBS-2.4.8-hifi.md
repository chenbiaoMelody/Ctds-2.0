...
- 对应规格：制度依据 =《C-TDS项目总体实施计划与WBS》2.4.8 产出定义（"标准适配层骨架 + 互联互通接口占位"，工作量 1 天）+ 章程 4.3 + WBS §1.7 强依赖 + PRD §5.9/§6.9 + ADR-002/005；方向确认 = `docs/designs/WBS-2.4.8-lofi.md`（待 PO 签署）
