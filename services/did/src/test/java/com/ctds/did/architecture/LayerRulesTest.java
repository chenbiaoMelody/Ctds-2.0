...
/**
 * 分层依赖规则（章程 4.3，模式同 kms/example-service/subject-service）：违反即单元测试门禁红灯。
 */
@AnalyzeClasses(packages = "com.ctds.did", importOptions = ImportOption.DoNotIncludeTests.class)
