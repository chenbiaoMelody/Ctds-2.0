package com.ctds.kms.architecture;
...
/**
 * 分层依赖规则（章程 4.3，模式同 example-service）：违反即单元测试门禁红灯。
 */
@AnalyzeClasses(packages = "com.ctds.kms", importOptions = ImportOption.DoNotIncludeTests.class)
